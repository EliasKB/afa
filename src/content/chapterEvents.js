      ...
      events: [
        {
          ...
          paragraphs: [
            ...
            'Kort föreläsning om AI.',
            'Röstning om vad folk vill göra.',
            'Gruppering av medlemmar så de kan lära känna varandra djupare, hjälpa med CV och intervjuträning eller diskutera ett specifikt ämne.',
            'Mini brainstorming, problemlösning eller hackathon för de som vill.',
            'Avslutningsvis äter vi middag tillsammans.',
          ],
          image: {
            src: gothenburgPoster,
            alt: 'Affisch för AFA Väst event i Göteborg den 2 maj 2026',
          },
        },
      ],
    },
      ...
      events: [
        {
          ...
          paragraphs: [
            ...
            'A short lecture on AI.',
            'A group vote on what participants want to do.',
            'Members will be grouped so they can get to know each other better, help with CVs and interview practice, or discuss a specific topic.',
            'A mini brainstorming session, problem solving, or hackathon for those who want it.',
            'We will end the evening by having dinner together.',
          ],
          image: {
            src: gothenburgPoster,
            alt: 'Poster for the AFA West event in Gothenburg on May 2, 2026',
          },
        },
      ],
    },
      ...
      events: [
        {
          ...
          closing:
            'Register by reacting with ✅ and mark your guest with 1️⃣, 2️⃣, or 3️⃣.',
          image: {
            src: stockholmAprilPoster,
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Bring a laptop.',
            'Register by reacting with ✅ so the team can plan the amount of refreshments.',
          ],
          image: {
            src: stockholmMarchPoster,
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Register by reacting with ✅ so the group can plan attendance properly.',
          ],
        },
      ],
    },
